...
ui.layout(
    <vertical padding="26" background="#FFA1887F" id="bj"  >
	   <text text="第一步"/>
       <checkbox id="sp1" text="findOne()"/>
         <horizontal>
            <text textSize="16sp">操作</text>
            <spinner id="sp2" entries="无动作     =>  ;|控件点击 => click()|获取文本 => getText()|前进滑动 => scrollForward()|后退滑动 => scrollBackward()" spinnerMode="dialog"/>
       ...
       <button id="ok" textSize="40sp" textStyle="bold" background="#7711aa1F">确定</button>
    </vertical>
);
