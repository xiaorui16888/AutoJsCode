...
function javaPaint(g,myPaint) {
  ...
  //绘图方法
  drawSilkTreeLeaf(g, 520, 666, 330, 27, K, D,myPaint);
...
function drawSilkTreeLeaf(g, x, y, L, a, K, D) {
  ...
  if (L > 2) {
    ...
    drawSilkTreeLeaf(g, x2R, y2R, L / 30, a + K, K, D);
    drawSilkTreeLeaf(g, x1L, y1L, L / 30, a - K, K, D);
    drawSilkTreeLeaf(g, x1R, y1R, L / 30, a + K, K, D);
  }
}
function rndColor() {
