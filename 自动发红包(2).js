...
launch(name);
    ...
    //判断是否开启软件并点击添加分身
    sleep(2000);
var fanhuizhi=jietupanduan(538,714,231,34,65);
toast("1");
if(fanhuizhi==1){
    toast("正打开软件");
...
if(fanhuizhi1==1){
    toast("红包金额数量界面");
    className("android.widget.EditText").text("").findOne().click()
    //console.show();
    //console.log(id("J_money"));
   // id("J_money").findOne().setText("1");
    //document.getElementById('J_money')
    //text("").setText("1000000")
    //desc("元").setText("1000000")
    //setText(0,0.9);
    //id("J_money").findOne("0.9");
    //setText(2,1);
